...
public class CreateTask {
    ...
    public void addNewTask(){
        ...
        switch (String.valueOf(priorita.getValue())){
            case "1- Velmi nízká": prioritaNum = 1;
            break;
            case "2 - Nízká ": prioritaNum = 2;
            break;
            case  "3 - Normální": prioritaNum = 3;
            break;
            case "4 - Vysoká": prioritaNum = 4;
            break;
            case "5 - Urgentní": prioritaNum = 5;
            break;
            default: prioritaNum = 0;
        }
        ...
        dotaz.close() ;
        if(name.getText() !=null && popis.getText()!=null && deadline.getValue()!=null && prioritaNum !=0 && group.getValue()!=null)close();
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    }
